<template>
  <div class="section">
    <div class="row">
      ...
      <div>
        <h3 class="center">Twój koszyk</h3>
      </div>
      <br><br>
      ...
      <table class="highlight">
        ...
        <tr>
          ...
          <td class="quantity"> <input id="quantity-input" type="number" min="1" :value="p.quantity"></td>
          <td class="price">{{computeSubTotal(p) | priceFormat}} zł</td>
          <td class="price">
            <a class="btn-floating white teal-text waves-effect waves-light"><i class="material-icons white teal-text">clear</i></a>
          </td>
        </tr>
        </tbody>
      ...
      <br><br>
      <div class="center">
        <a class="waves-effect waves-light btn-large teal white-text"><i class="material-icons right teal white-text">navigate_next</i>Przejdź do platnosci</a>
      </div>
    </div>
  </div>
</template>
